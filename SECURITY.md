...
1. **Preferred**: Use [GitHub private vulnerability reporting](https://github.com/jerdaw/healtharchive-datasets/security/advisories/new) to submit a report directly through GitHub.
